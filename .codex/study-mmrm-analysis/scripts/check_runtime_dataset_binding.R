...
for (helper in c("io.R", "intake_extraction.R", "intake_review.R", "runtime_dataset_binding.R", "canonical_hash.R", "standard_contract.R", "standard_analysis_definition.R", "analysis_approval.R")) source(file.path(helper_dir, helper), encoding = "UTF-8")
