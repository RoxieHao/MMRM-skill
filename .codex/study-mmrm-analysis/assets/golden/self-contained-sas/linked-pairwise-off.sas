...
/* 研究：SYNTHETIC；分析：MMRM-06；TFL：T14-06 */
...
/* PROGRAM-MARKER:IDENTITY:ANALYSIS:MMRM-06 */
/* PROGRAM-MARKER:IDENTITY:TFL:T14-06 */
...
/* PROGRAM-MARKER:OUTPUT:r_raw_file:T14-06_r_raw.csv */
/* PROGRAM-MARKER:OUTPUT:r_final_file:T14-06_r_final.csv */
/* PROGRAM-MARKER:OUTPUT:r_diagnostic_file:T14-06_r_diagnostic.csv */
/* PROGRAM-MARKER:OUTPUT:r_run_record_file:T14-06_r_run_record.csv */
/* PROGRAM-MARKER:OUTPUT:sas_raw_file:T14-06_sas_raw.csv */
/* PROGRAM-MARKER:OUTPUT:sas_final_file:T14-06_sas_final.csv */
/* PROGRAM-MARKER:OUTPUT:sas_diagnostic_file:T14-06_sas_diagnostic.csv */
/* PROGRAM-MARKER:OUTPUT:sas_run_record_file:T14-06_sas_run_record.csv */
...
%let SAS_RAW_FILE=T14-06_sas_raw.csv;
%let SAS_FINAL_FILE=T14-06_sas_final.csv;
%let SAS_DIAGNOSTIC_FILE=T14-06_sas_diagnostic.csv;
%let SAS_RUN_RECORD_FILE=T14-06_sas_run_record.csv;
...
%macro mmrm_estimand_statements;
  ...
  lsmeans _treatment*_visit / cl alpha=0.05;
%mend;
