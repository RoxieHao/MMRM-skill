...
/* 研究：SYNTHETIC；分析：MMRM-01；TFL：T14-01 */
...
/* PROGRAM-MARKER:IDENTITY:TFL:T14-01 */
...
/* PROGRAM-MARKER:OUTPUT:r_raw_file:T14-01_r_raw.csv */
/* PROGRAM-MARKER:OUTPUT:r_final_file:T14-01_r_final.csv */
/* PROGRAM-MARKER:OUTPUT:r_diagnostic_file:T14-01_r_diagnostic.csv */
/* PROGRAM-MARKER:OUTPUT:r_run_record_file:T14-01_r_run_record.csv */
/* PROGRAM-MARKER:OUTPUT:sas_raw_file:T14-01_sas_raw.csv */
/* PROGRAM-MARKER:OUTPUT:sas_final_file:T14-01_sas_final.csv */
/* PROGRAM-MARKER:OUTPUT:sas_diagnostic_file:T14-01_sas_diagnostic.csv */
/* PROGRAM-MARKER:OUTPUT:sas_run_record_file:T14-01_sas_run_record.csv */
...
%let SAS_RAW_FILE=T14-01_sas_raw.csv;
%let SAS_FINAL_FILE=T14-01_sas_final.csv;
%let SAS_DIAGNOSTIC_FILE=T14-01_sas_diagnostic.csv;
%let SAS_RUN_RECORD_FILE=T14-01_sas_run_record.csv;
