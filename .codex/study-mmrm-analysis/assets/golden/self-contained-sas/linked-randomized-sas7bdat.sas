...
/* 研究：SYNTHETIC；分析：MMRM-04；TFL：T14-04 */
...
/* PROGRAM-MARKER:IDENTITY:TFL:T14-04 */
...
/* 批准的数据文件名：scores.sas7bdat；格式：sas7bdat */
...
/* PROGRAM-MARKER:OUTPUT:r_raw_file:T14-04_r_raw.csv */
/* PROGRAM-MARKER:OUTPUT:r_final_file:T14-04_r_final.csv */
/* PROGRAM-MARKER:OUTPUT:r_diagnostic_file:T14-04_r_diagnostic.csv */
/* PROGRAM-MARKER:OUTPUT:r_run_record_file:T14-04_r_run_record.csv */
/* PROGRAM-MARKER:OUTPUT:sas_raw_file:T14-04_sas_raw.csv */
/* PROGRAM-MARKER:OUTPUT:sas_final_file:T14-04_sas_final.csv */
/* PROGRAM-MARKER:OUTPUT:sas_diagnostic_file:T14-04_sas_diagnostic.csv */
/* PROGRAM-MARKER:OUTPUT:sas_run_record_file:T14-04_sas_run_record.csv */
...
%let DATASET_FILE=scores.sas7bdat;
%let DATASET_FORMAT=sas7bdat;
%let EXPECTED_INPUT_SHA256=AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
%let SAS_RAW_FILE=T14-04_sas_raw.csv;
%let SAS_FINAL_FILE=T14-04_sas_final.csv;
%let SAS_DIAGNOSTIC_FILE=T14-04_sas_diagnostic.csv;
%let SAS_RUN_RECORD_FILE=T14-04_sas_run_record.csv;
